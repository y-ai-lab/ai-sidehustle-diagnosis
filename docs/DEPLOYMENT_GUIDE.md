...
```text
https://y-ai-lab.github.io/ai-sidehustle-diagnosis/
```
...
`https://y-ai-lab.github.io/ai-sidehustle-diagnosis/` が `There isn't a GitHub Pages site here.` になる場合は、コードより先にGitHub側の設定を確認します。
